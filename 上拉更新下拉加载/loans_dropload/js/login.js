$(function () {
    ...
    //  电信号码段：133、153、180、189、199、198、166、177、145 、149、 176 、175、 171
            //var regExp=/^1((3\d)|(4[579])|(5[0123789])|(6(6))|(7[1567])|(8[02356789]))|(9([89]))\d{8}$/; 
        } else if (!/^1((3\d)|(4[579])|(5[0123789])|(6(6))|(7[1567])|(8[02356789]))|(9([89]))\d{8}$/.test(phoneValue)) {
            $("#phone").addClass("error");
    ...
    function getCode() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                type_id?$(".getImg_left").css({ 'background-image': `url(${newImg})`, "background-repeat": "no-repeat", 'background-size': ' 2.4rem 0.88rem' }):$(".getImg_left").css({ 'background-image': `url(${newImg})`, "background-repeat": "no-repeat", 'background-size': ' 10rem 3.67rem' })
